    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <h4 className="text-lg font-semibold mb-6">News & Events</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {blogPosts.map((post, index) => (
              <div key={index} className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors">
                ...
                <Link href={post.href} className="text-white hover:text-blue-400 transition-colors">
                  {post.title}
                </Link>
              </div>
            ))}
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>Copyright © 2025 MoLab. All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
