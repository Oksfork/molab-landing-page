...
import team9Thumb from "@/assets/img/team/9.jpg"
                            ...
                            <div className="blog-content wow fadeInUp col-lg-10 offset-lg-1 col-md-12">
                                <div className="blog-style-one item">
                                    <div className="blog-item-box">
                                        <div className="thumb">
                                            <Image src={`/assets/img/blog/${thumbFull}`} alt="Thumb" width={1020} height={508} />
                                        </div>
                                        <div className="info">
                                            <div className="meta">
                                                <ul>
                                                    <li>
                                                        <i className="fas fa-user" /> <Link href="#" scroll={false}>{author}</Link>
                                                    </li>
                                                    <li>
                                ...
                                <div className="post-author">
                                    <div className="thumb">
                                        <Image src={team9Thumb} alt="Thumb" />
                                    </div>
                                    <div className="info">
