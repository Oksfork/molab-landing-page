...
const PriceV5 = () => {
    ...
    return (
        <>
            <div className="pricing-area secondary default-padding bg-gray bg-cover" style={{ backgroundImage: 'url(/assets/img/shape/1.png)' }}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2">
                            <div className="site-heading text-center">
                                <h5 className="sub-heading">Best Pricing</h5>
                                <h2 className="title">No hidden & extra charges! <br /> choose your plan.</h2>
                            </div>
                        </div>
                    </div>
                </div>
